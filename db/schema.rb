...
ActiveRecord::Schema.define(version: 20160814191901) do
  ...
  create_table "payments", force: :cascade do |t|
    t.integer "student_id"
    t.integer "payment_date_id"
    t.date    "paid_at"
  end

  add_index "payments", ["payment_date_id"], name: "index_payments_on_payment_date_id", using: :btree
  ...
  add_foreign_key "payments", "payment_dates"
